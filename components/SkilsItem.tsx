  ...
  return (
    <div className="mb-[4rem] md:mb-[8rem]">
      ...
      <p className="text-[#aaaaaa] font-normal w-[80%] text-[17px] opacity-80">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Totam tempore amet  
        nisi optio delectus corporis accusantium nostrumsaepe, maiores
         fuga sunt enim earum autem maxime. Animi odit voluptates est?
         </p>
    </div>
  )
}
